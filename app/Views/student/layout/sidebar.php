      ...
      <div class="container-fluid">
          <nav class="sidebar-nav">
              <ul class="nav in side-menu">
                  <li class="menu-item"><a href="<?= base_url('student/dashboard') ?>"><i class="list-icon material-icons">home</i> <span class="hide-menu">Dashboard</span></a></li>
                  <li class="menu-item"><a href="<?= base_url('student/profile-preview') ?>"><i class="list-icon material-icons">person_outline</i> <span class="hide-menu">Profile</span></a></li>
                  <li class="menu-item"><a href="<?= base_url('student/logout') ?>"><i class="list-icon material-icons">input</i> <span class="hide-menu">Logout</span></a></li>
                  <!-- <li class="current-page menu-item-has-children"><a href="index.html"><i class="list-icon material-icons">home</i> <span class="hide-menu">Dashboard</span></a>
                      <ul class="list-unstyled sub-menu">
                          ...
                          <li><a href="../dark-sidebar/index.html">Dark Sidebar</a>
                          </li>
                          <li><a href="../dark-collapse/index.html">Dark Collapse</a>
                          </li>
                          <li><a href="../horizontal-fluid/index.html">Horizontal Fluid</a>
                          </li>
                          <li><a href="../horizontal-container/index.html">Horizontal Container</a>
                          </li>
                          <li><a href="../rtl/index.html">RTL</a>
                          </li>
                      </ul>
                  </li>
                  <li class="menu-item-has-children active"><a href="javascript:void(0);"><i class="list-icon material-icons">apps</i> <span class="hide-menu">Apps <span class="badge bg-primary">6</span></span></a>
                      <ul class="list-unstyled sub-menu">
                          ...
                          <li class="menu-item-has-children"><a href="javascript:void(0);">Sample Pages</a>
                              <ul class="list-unstyled sub-menu">
                          ...
                          <li class="menu-item-has-children"><a href="javascript:void(0);">Profile Pages</a>
                              <ul class="list-unstyled sub-menu">
                  ...
                  <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon material-icons">grid_on</i> <span class="hide-menu">Tables</span></a>
                      <ul class="list-unstyled sub-menu">
                  ...
                  <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon material-icons">lightbulb_outline</i> <span class="hide-menu">UI Elements <span class="badge bg-pink">7</span></span></a>
                      <ul class="list-unstyled sub-menu">
                  ...
                  <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon material-icons">tune</i> <span class="hide-menu">Forms</span></a>
                      <ul class="list-unstyled sub-menu">
                  ...
                  <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon material-icons">insert_chart</i> <span class="hide-menu">Charts</span></a>
                      <ul class="list-unstyled sub-menu">
